...
Services Automated
AWS IAM: Creates an IAM Role and Instance Profile dynamically with AmazonS3ReadOnlyAccess.
Amazon S3: Creates a completely private S3 bucket and uploads an index.html file to it.
Amazon EC2: Provisions a web server, attaches the secure IAM Instance Profile, and automatically executes a startup script.
The Magic
